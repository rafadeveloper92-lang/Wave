...
import { loadHiddenChatIds, loadProfile, saveHiddenChatIds } from './lib/waveLocalUi';
...
export default function App() {
  ...
  const [hiddenChatIds, setHiddenChatIds] = useState<Set<string>>(() => loadHiddenChatIds());
