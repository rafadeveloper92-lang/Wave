    ...
    >
      ...
      <div className="relative h-72 w-full overflow-hidden">
        ...
        <div className="absolute top-8 left-6">
          <h2 className="text-4xl font-bold text-white drop-shadow-lg">Perfil</h2>
        </div>
        ...
        <button 
          ...
          className="absolute bottom-4 right-6 p-2 bg-black/40 backdrop-blur-md rounded-xl text-white/50 border border-white/5 hover:text-white transition-all"
        >
          <Camera size={16} />
        </button>
      </div>
      ...
      <div className="px-6 -mt-24 relative z-10">
        <div className="flex flex-col items-center">
          ...
          <div className="relative group">
            ...
            <button 
              ...
              className="absolute bottom-2 right-2 bg-[#1e293b] p-3 rounded-full border-2 border-[#020617] text-brand shadow-xl active:scale-90 transition-transform"
            >
              <Edit3 size={20} />
            </button>
          </div>
          ...
          <div className="w-full mt-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] p-8 text-center space-y-6 shadow-2xl">
            <div>
              <h3 className="text-4xl font-bold text-white tracking-tight">Lucas Silva</h3>
        ...
        <div className="mt-10 space-y-6">
          <div className="flex items-center justify-between px-2">
            <h3 className="font-bold text-xl text-white">Meus Posts</h3>
